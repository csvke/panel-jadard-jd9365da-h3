...
static const struct jadard_init_cmd BNS080B40HD9650113A_init_cmds[] = {
	...
	{ .data = { 0xE0, 0x01 } },
	{ .data = { 0x00, 0x00 } },
	{ .data = { 0x01, 0x77 } }, // different from radxa_display_8hd_ad002_init_cmds[]
	{ .data = { 0x03, 0x00 } },
	{ .data = { 0x04, 0x65 } },
...
static const struct jadard_panel_desc BNS080B40HD9650113A_desc = {
	...
	.mode = {
		.clock		= 68000, // not sure if thi is = Pixel CLK in datasheet

		.hdisplay   = 800, // Hadr in datasheet
		.hsync_start = 800 + 40,  // Hadr + HFP
		.hsync_end  = 800 + 40 + 20,  // Hadr + HFP + HS
		.htotal     = 800 + 40 + 20 + 20,  // hdisplay + HFP + HS + HBP

		.vdisplay   = 1280, // Vadr in datasheet
		.vsync_start = 1280 + 30,  // Vadr + VFP
		.vsync_end  = 1280 + 30 + 4,  // Vadr + VFP + VS
		.vtotal     = 1280 + 30 + 4 + 12,  // Vadr + VFP + VS + VBP

		.width_mm	= 107, // not sure if this is referring to 'Panel Active Area' in datasheet
		.height_mm	= 172, // not sure if this is referring to 'Panel Active Area' in datasheet
		.type		= DRM_MODE_TYPE_DRIVER | DRM_MODE_TYPE_PREFERRED,
	},
	.lanes = 4,
	.format = MIPI_DSI_FMT_RGB888,
